...
namespace MultiPatchExamples
{
    public static class ExtrusionExamples
    {
        ...
        public static IGeometry GetExample31()
        {
            const double FromZ = 0;
            const double ToZ = 9.5;
            ...
            polygonPointCollection.AddPoint(GeometryUtilities.ConstructPoint2D(0, 0), ref _missing, ref _missing);
            polygonPointCollection.AddPoint(GeometryUtilities.ConstructPoint2D(0, 4), ref _missing, ref _missing);
            polygonPointCollection.AddPoint(GeometryUtilities.ConstructPoint2D(4, 4), ref _missing, ref _missing);
            polygonPointCollection.AddPoint(GeometryUtilities.ConstructPoint2D(4, 0), ref _missing, ref _missing);
        ...
        public static IGeometry GetExample32()
        {
            const double FromZ = 0;
            const double ToZ = 9.5;
            ...
            polygonPointCollection.AddPoint(GeometryUtilities.ConstructPoint2D(1, 1), ref _missing, ref _missing);
            polygonPointCollection.AddPoint(GeometryUtilities.ConstructPoint2D(1, 3), ref _missing, ref _missing);
            polygonPointCollection.AddPoint(GeometryUtilities.ConstructPoint2D(3, 3), ref _missing, ref _missing);
            polygonPointCollection.AddPoint(GeometryUtilities.ConstructPoint2D(3, 1), ref _missing, ref _missing);
